...
it('toggle selection with ctrl + click', async () => {
  ...
  userEvent.click(item0, { ctrlKey: true });
  expect(onFocus).toBeCalledTimes(1);
  expect(onFocus).toBeCalledWith(0);
  ...
  userEvent.click(item1, { ctrlKey: true });
  expect(onFocus).toBeCalledTimes(1);
  ...
  userEvent.click(item2, { ctrlKey: true });
  expect(onFocus).toBeCalledTimes(1);
  ...
  expect(onSelect).not.toBeCalled();
  expect(onUnselect).toBeCalledTimes(1);
  expect(onUnselect).toBeCalledWith(2);
});
